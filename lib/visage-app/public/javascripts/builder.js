...
var ChartBuilder = new Class({
    ...
    setupPercentileSelection: function() {
        ...
        //var container = this.builder.getElement("div#percentiles");
        ...
        if (container) {
            var percentileSelector = new Element('input', {
                ...
                'name': 'percentiles_95',
                'checked': this.options.percentiles95,
                'events': {
                    'click': function() {
                        this.options.percentiles95 = !this.options.percentiles95
                    }.bind(this)
                },
                'styles': {
                    'margin-right': '4px',
            ...
            console.dir("setupPercentileSelection ... container:");
                ...
                'events': {
                    'click': function() {
                        var hosts   = this.searchers.host.tokenValues(),
                            ...
                            percentiles   = [];
                            percentiles95 = this.options.percentiles95;
