...
web build:
 - http://mootools.net/core/fe054172ab4d991287ca1d45e88d84d3

packager build:
 - packager build Core/Browser Core/Class Core/Element Core/Element.Style Core/Element.Event Core/Element.Delegation Core/Request Core/Request.JSON Core/DOMReady
...
Array[e]=function(q){return p.apply(Array.from(q),n.call(arguments,1));};});}})();(function(){var a=this.Class=new Type("Class",function(h){if(instanceOf(h,Function)){h={initialize:h};
...
for(var i in h){f.call(this,i,h[i],true);}},this);}};})();(function(){var a=Object.prototype.hasOwnProperty;Object.extend({subset:function(d,g){var f={};
...
}}}return this;}};[Element,Window,Document].invoke("implement",{addEvent:e(f,g.addEvent),removeEvent:e(j,g.removeEvent)});})();(function(){this.Chain=new Class({$chain:[],chain:function(){this.$chain.append(Array.flatten(arguments));
