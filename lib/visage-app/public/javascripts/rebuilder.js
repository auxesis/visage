...
(function() {
  ...
  window.addEvent('domready', function() {
    var Dimension, DimensionCollectionView, DimensionView, Graph, GraphCollection, GraphCollectionView, GraphView, Host, HostCollection, Metric, MetricCollection, Profile, Timeframe, TimeframeCollection, TimeframeCollectionView, TimeframeView, button, graphs, graphsContainer, graphsView, hosts, hostsContainer, hostsView, metrics, metricsContainer, metricsView, profile, timeframes, timeframesView;
    ...
    TimeframeCollectionView = Backbone.View.extend({
      ...
      render: function() {
        ...
        return that.collection.each(function(model) {
          var view;
          if (timeframe && timeframe.label === model.get('label')) {
