...
(function() {
  ...
  window.addEvent('domready', function() {
    var Dimension, DimensionCollectionView, DimensionView, Graph, GraphCollection, Host, HostCollection, Metric, MetricCollection, button, hosts, hostsContainer, hostsView, metrics, metricsContainer, metricsView;
    ...
    button = new Element('input', {
      ...
      'events': {
        'click': function(event) {
          var graphs, selected_hosts, selected_plugins;
          ...
          return selected_hosts.each(function(host) {
            return selected_plugins.each(function(plugin) {
              ...
              element = new Element('div', {
                'class': "graph " + host + " " + plugin
              });
              graphs.grab(element);
              return graph = new VisageGraph(element, host, plugin);
            });
          });
        }
      }
