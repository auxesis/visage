...
(function() {
  ...
  Profile = Backbone.Model.extend({
    ...
    validate: function(attrs, options) {
      if (!attrs || !attrs.id) {
        if (attrs === void 0 || attrs.graphs === void 0 || attrs.graphs.length === 0) {
