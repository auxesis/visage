...
(function() {
  ...
  Profile = Backbone.Model.extend({
    ...
    isRelative: function() {
      ...
      return this.get('timeframe') === 'relative';
    },
    initialize: function() {
      var id;
    ...
    if (!window.profile.isNew()) {
      window.profile.fetch({
        success: function(model) {
          model.get('graphs').each(function(attributes) {
            var graph;
