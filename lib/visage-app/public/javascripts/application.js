...
(function() {
  ...
  window.addEvent('domready', function() {
    var Workspace, button, get_selected_hosts, get_selected_metrics, hosts, hostsContainer, hostsView, metrics, metricsContainer, metricsView, timeframes, timeframesView;
    ...
    get_selected_hosts = function() {
      return hosts.selected().map(function(host) {
        return host.get('id');
      }).unique();
    };
    get_selected_metrics = function() {
      ...
      selected = {};
      selected_metrics = [];
      metrics.selected().each(function(metric) {
