...
(function() {
  ...
  GraphCollectionView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      return shareToggler.addEvent('click', function() {
        ...
        if (current.test(/new$/)) {
          graphAttributes = window.graphs.toJSON().map(function(attrs) {
  ...
  window.addEvent('domready', function() {
    var Workspace, button, hosts, hostsContainer, hostsView, metrics, metricsContainer, metricsView, profile, timeframes, timeframesView;
