...
module Visage
  class Data
    def initialize(opts={})
      @rrddir        = opts[:rrddir] || Visage::Data.rrddir
      @types         = opts[:types]  || Visage::Data.types
      @collectdsock  = opts[:collectdsock] || Visage::Data.collectdsock
      @rrdcachedsock = opts[:rrdcachedsock] || Visage::Data.rrdcachedsock
    end
